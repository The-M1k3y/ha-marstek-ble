---
type: BLE Message
title: Venus 0x05 EPS mode
description: Boolean EPS-mode control message.
...
| ------: | -----: | ---- | --------- | ------- | -------------------------------------------------------- |
| `0x00` | 1      | `u8` | `enabled` | boolean | `0x01` enables EPS mode; `0x00` disables it.             |
