---
type: BLE Message
title: Venus 0x06 AC input
description: Boolean AC-input control message.
...
| ------: | -----: | ---- | --------- | ------- | -------------------------------------------------------- |
| `0x00` | 1      | `u8` | `enabled` | boolean | `0x01` enables AC input; `0x00` disables it.             |
